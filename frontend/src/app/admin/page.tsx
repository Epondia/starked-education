  ...
  return (
    ...
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-lg p-4 sm:p-6 text-white">
        ...
        <p className="text-sm sm:text-base text-blue-100">Here&apos;s what&apos;s happening on your platform today.</p>
      </div>
        ...
        <div className="lg:col-span-2 bg-white rounded-lg shadow-md p-4 sm:p-6">
          ...
          <div className="space-y-2 sm:space-y-3">
            {recentActivity.slice(0, 5).map((activity) => (
              <div key={activity.id} className="flex items-center gap-3 p-2 sm:p-3 hover:bg-gray-50 rounded-lg">
                <div className={`p-2 rounded-lg shrink-0 ${getStatusColor(activity.status)}`}>
                  {getActivityIcon(activity.type)}
                </div>
                <div className="flex-1 min-w-0">
                  <h4 className="font-medium text-gray-800 text-sm truncate">{activity.title}</h4>
        ...
        <div className="bg-white rounded-lg shadow-md p-4 sm:p-6">
          ...
          <div className="space-y-2 sm:space-y-3">
            {hasPermission('user:create') && (
              <button className="w-full text-left px-4 py-3 bg-blue-50 text-blue-700 rounded-lg hover:bg-blue-100 transition-colors touch-target">
            ...
            {hasPermission('course:create') && (
              <button className="w-full text-left px-4 py-3 bg-green-50 text-green-700 rounded-lg hover:bg-green-100 transition-colors touch-target">
            ...
            {hasPermission('system:manage') && (
              <button className="w-full text-left px-4 py-3 bg-purple-50 text-purple-700 rounded-lg hover:bg-purple-100 transition-colors touch-target">
